    ...
    <S.AboutPage>
      ...
      <S.Instructions>
        ...
        <S.Instruction expanded={expended2} onChange={(): void => setExpended2((state) => !state)}>
          ...
          <S.Details>
            <Typography>
              Существуют масштабные программы приёма вторсырья, направленные на широкую аудиторию
              (например &quot;синие контейнеры&quot; в Москве). В целом это более удобный (рядом с
              домом, нет строгих правил, мало фракций), но не очень эффективный способ сортировки и
              переработки вторсырья. Это намного лучше, чем не сортировать вовсе, так что если вы не
              чувствуете желания и ресурсов ездить подальше или заказывать эко-такси, то
              остановитесь на нём. К сожалению на данном этапе, из-за большого количества таких
              пунктов приёма, поддерживать информацию о них не представляется возможным.
            </Typography>
            <Divider variant="middle" />
            <Typography>
